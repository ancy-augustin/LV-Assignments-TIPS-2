...
<Project Type="Project" LVVersion="23008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Source" Type="Folder">
			<Item Name="Custom Sort Paths" Type="Folder">
				<Item Name="Files" Type="Folder">
					<Item Name="Log.csv" Type="Document" URL="../Files/Log.csv"/>
					<Item Name="Path.txt" Type="Document" URL="../Files/Path.txt"/>
				</Item>
				<Item Name="Library" Type="Folder">
					<Item Name="File and Path Operations.lvlib" Type="Library" URL="../Library/File Path Operations/File and Path Operations.lvlib"/>
					<Item Name="Test.lvlib" Type="Library" URL="../Library/Test/Test.lvlib"/>
				</Item>
