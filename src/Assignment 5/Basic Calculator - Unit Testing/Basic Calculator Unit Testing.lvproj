		...
		<Item Name="Source" Type="Folder">
			<Item Name="Classes" Type="Folder">
				...
				<Item Name="Test VI" Type="Folder">
					<Item Name="TestLib.lvlib" Type="Library" URL="../Classes/Test VI/TestLib.lvlib"/>
				</Item>
				<Item Name="Typedef" Type="Folder">
					<Item Name="ClassClusters.ctl" Type="VI" URL="../Classes/Typedef/ClassClusters.ctl"/>
					<Item Name="Operations.ctl" Type="VI" URL="../Classes/Typedef/Operations.ctl"/>
					<Item Name="QueueOperations.ctl" Type="VI" URL="../Classes/Typedef/QueueOperations.ctl"/>
					<Item Name="TestCaseSampleIO.ctl" Type="VI" URL="../Classes/Typedef/TestCaseSampleIO.ctl"/>
				</Item>
			</Item>
