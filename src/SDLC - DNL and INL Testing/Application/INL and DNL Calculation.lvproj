...
<Project Type="Project" LVVersion="23008000">
	...
	<Property Name="NI.Project.Description" Type="Str">The project contains the necessary files to perform the INL and DNL testing for DAC devices.</Property>
		...
		<Item Name="Source" Type="Folder">
			<Item Name="INL DNL" Type="Folder">
				...
				<Item Name="Typedef" Type="Folder">
					<Item Name="INL DNL Data.ctl" Type="VI" URL="../Typedef/INL DNL Data.ctl"/>
					<Item Name="INL Method.ctl" Type="VI" URL="../Typedef/INL Method.ctl"/>
					<Item Name="Input Values.ctl" Type="VI" URL="../Typedef/Input Values.ctl"/>
